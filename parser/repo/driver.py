...
def create_tables():
    client.command("""CREATE TABLE IF NOT EXISTS quake.quakes
    (
        Magnitude Float64,
    ...
    """)
    client.command("""CREATE TABLE IF NOT EXISTS quake.quakes_class
    (
        Magnitude Int8,
        Date DateTime('Europe/London'),
        Longitude Float64,
    ...
    PRIMARY KEY (Longitude, Latitude, Date)
    """)
    client.command("""CREATE TABLE IF NOT EXISTS quake.quakes_class_enrich
    (
        Magnitude Int8,
        Date DateTime('Europe/London'),
        Longitude Float64,
...
def drop_tables(table: str = 'quakes'):
